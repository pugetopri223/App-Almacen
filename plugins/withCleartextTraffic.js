...
const SECTIGO_ROOT_R46 = `-----BEGIN CERTIFICATE-----
...
module.exports = function withCleartextTraffic(config) {
	...
	config = withDangerousMod(config, [
		...
		async (configWithMod) => {
			...
			fs.writeFileSync(
				path.join(rawDir, "sectigo_ca_dv_r36.pem"),
				SECTIGO_CA_DV_R36,
			);

			fs.writeFileSync(
				path.join(rawDir, "sectigo_root_r46.pem"),
				SECTIGO_ROOT_R46,
			);
...
<network-security-config>
	<domain-config cleartextTrafficPermitted="true">
		<domain includeSubdomains="true">cerraco.mx</domain>
		<domain includeSubdomains="true">mov.cerraco.mx</domain>
		<trust-anchors>
